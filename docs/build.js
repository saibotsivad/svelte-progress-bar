(function () {
    ...
    function add_css(target) {
    	append_styles(target, "svelte-p1fj7t", ".svelte-progress-bar{position:fixed;top:0;left:0;height:2px;transition:width 0.21s ease-in-out;z-index:1}.svelte-progress-bar-hiding{transition:top 0.8s ease;top:-8px}.svelte-progress-bar-leader{position:absolute;top:0;right:0;height:3px;width:100px;transform:rotate(2.5deg) translate(0px, -4px);box-shadow:0 0 8px;z-index:2}");
    }
    ...
    function create_if_block(ctx) {
    	let div;
    	let div_style_value;
    	let if_block = /*running*/ ctx[5] && create_if_block_1(ctx);
    	...
    	return {
    		c() {
    			...
    			attr(div, "style", div_style_value = "" + (/*barStyle*/ ctx[1] + /*barZIndexStyle*/ ctx[2]));
    			toggle_class(div, "running", /*running*/ ctx[5]);
    			toggle_class(div, "svelte-progress-bar-hiding", /*completed*/ ctx[6]);
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*barStyle, barZIndexStyle*/ 6 && div_style_value !== (div_style_value = "" + (/*barStyle*/ ctx[1] + /*barZIndexStyle*/ ctx[2]))) {
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "style", div_style_value = "" + (/*leaderColorStyle*/ ctx[3] + /*leaderZIndexStyle*/ ctx[4]));
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		},
    		p(ctx, dirty) {
    			if (dirty & /*leaderColorStyle, leaderZIndexStyle*/ 24 && div_style_value !== (div_style_value = "" + (/*leaderColorStyle*/ ctx[3] + /*leaderZIndexStyle*/ ctx[4]))) {
    				attr(div, "style", div_style_value);
    			}
    		},
    		d(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { barStyle } = $$props;
    	let { barZIndexStyle } = $$props;
    	let { leaderColorStyle } = $$props;
    	let { leaderZIndexStyle } = $$props;

    	$$self.$$set = $$props => {
    		if ('zIndex' in $$props) $$invalidate(7, zIndex = $$props.zIndex);
    		if ('color' in $$props) $$invalidate(8, color = $$props.color);
    		if ('width' in $$props) $$invalidate(0, width = $$props.width);
    		if ('minimum' in $$props) $$invalidate(9, minimum = $$props.minimum);
    		if ('maximum' in $$props) $$invalidate(10, maximum = $$props.maximum);
    		if ('settleTime' in $$props) $$invalidate(11, settleTime = $$props.settleTime);
    		if ('intervalTime' in $$props) $$invalidate(12, intervalTime = $$props.intervalTime);
    		if ('stepSizes' in $$props) $$invalidate(13, stepSizes = $$props.stepSizes);
    		if ('barStyle' in $$props) $$invalidate(1, barStyle = $$props.barStyle);
    		if ('barZIndexStyle' in $$props) $$invalidate(2, barZIndexStyle = $$props.barZIndexStyle);
    		if ('leaderColorStyle' in $$props) $$invalidate(3, leaderColorStyle = $$props.leaderColorStyle);
    		if ('leaderZIndexStyle' in $$props) $$invalidate(4, leaderZIndexStyle = $$props.leaderZIndexStyle);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*color, width*/ 257) {
    			$$invalidate(1, barStyle = (color && `background-color: ${color};` || '') + (width && width * 100 && `width: ${width * 100}%;` || ''));
    		}

    		if ($$self.$$.dirty & /*zIndex*/ 128) {
    			$$invalidate(2, barZIndexStyle = typeof zIndex !== 'undefined' && `z-index: ${zIndex};` || '');
    		}

    		if ($$self.$$.dirty & /*color*/ 256) {
    			$$invalidate(3, leaderColorStyle = color && `background-color: ${color}; color: ${color};` || '');
    		}

    		if ($$self.$$.dirty & /*zIndex*/ 128) {
    			$$invalidate(4, leaderZIndexStyle = typeof zIndex !== 'undefined' && `z-index: ${parseInt(zIndex, 10) + 1};` || '');
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	let progressbar_props = { color: "blue", zIndex: "13" };
